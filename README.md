...
MacOS or Linux users should check the [FAQ](https://victimofleisure.github.io/Polymeter/faq.html) for possible solutions. A virtual desktop running Windows is best, but Wine may work acceptably. The release notes are [here](https://victimofleisure.github.io/Polymeter/relnotes.html).
